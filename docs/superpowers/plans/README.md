...
| 3 | `supersolid_runtime` reactive core | JS runtime module in Boa: `createSignal`/`createEffect`/`createMemo`/`onMount`/`onCleanup`/`createContext`/`useContext` + scheduler. Headless. | 📝 In progress ([plan](./2026-07-19-supersolid-phase2-03-reactive-core.md)) |
